...
import com.anharness.app.accessibility.MinisAccessibilityService
import com.anharness.app.accessibility.RestrictedSettingsManager
import com.anharness.app.offload.ShizukuManager
import com.anharness.app.power.PowerOptimizationManager
    ...
    Scaffold(
        ...
        Column(
            ...
            var correctionEnabled by remember {
                mutableStateOf(
                    com.anharness.app.speech.correction.VoiceCorrectionConsent.isEnabled(context),
                )
            }
