...
import com.anharness.app.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<com.anharness.app.data.model.ModelEntry?>(null) }
