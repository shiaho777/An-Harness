...
import com.anharness.app.data.model.normalizeModalityName
...
internal suspend fun performTest(
    ...
    if (kind == QuickTestKind.SPEECH_OUT || kind == QuickTestKind.TRANSCRIPTION) {
        val voice = com.anharness.app.provider.voice.VoiceProviderFactory.make(instance, apiKey)
                ...
                if (!voice.supportsVoiceOutput) {
                    ...
                    runCatching {
                        ...
                        val data = voice.synthesize(
                            com.anharness.app.provider.voice.VoiceOutputRequest(
                ...
                if (!voice.supportsVoiceInput) {
                    ...
                    runCatching {
                        val resp = voice.transcribe(
                            com.anharness.app.provider.voice.VoiceInputRequest(
                                audioData = clip,
