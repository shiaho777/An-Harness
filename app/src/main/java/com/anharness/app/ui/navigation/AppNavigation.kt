package com.anharness.app.ui.navigation
...
import com.anharness.app.deeplink.DeepLinkAction
import com.anharness.app.deeplink.DeepLinkCoordinator
import com.anharness.app.ui.settings.KEY_LAUNCH_SESSION
import com.anharness.app.ui.settings.getAppearancePrefs
...
import com.anharness.app.ui.chat.ChatScreen
import com.anharness.app.ui.sessions.SessionListScreen
import com.anharness.app.ui.settings.AboutScreen
import com.anharness.app.ui.settings.AddAgentLoopGroupsScreen
import com.anharness.app.ui.settings.AddAgentLoopModelsScreen
import com.anharness.app.ui.settings.AddCustomModelScreen
import com.anharness.app.ui.settings.BackgroundSettingsScreen
import com.anharness.app.ui.settings.AddModelsToGroupScreen
import com.anharness.app.ui.settings.ShadowVoiceDetailScreen
import com.anharness.app.ui.settings.AddProviderScreen
import com.anharness.app.ui.settings.ModelEntryDetailScreen
import com.anharness.app.ui.settings.ModelGroupDetailScreen
import com.anharness.app.ui.settings.ModelGroupsScreen
import com.anharness.app.ui.settings.ProviderDetailScreen
import com.anharness.app.ui.settings.ProviderListScreen
import com.anharness.app.ui.sandbox.FileBrowserScreen
import com.anharness.app.ui.sandbox.FileBrowserViewModel
import com.anharness.app.ui.sandbox.FileItem
import com.anharness.app.ui.sandbox.FilePreviewScreen
import com.anharness.app.ui.sandbox.RootfsManagementScreen
import com.anharness.app.ui.settings.EnvironmentVariablesScreen
import com.anharness.app.ui.settings.AppearanceScreen
import com.anharness.app.ui.settings.SettingsScreen
import com.anharness.app.ui.settings.SystemPermissionsScreen
import com.anharness.app.ui.settings.SessionStorageDetailScreen
import com.anharness.app.ui.settings.SkillDetailScreen
import com.anharness.app.ui.settings.StorageManagementScreen
import com.anharness.app.ui.settings.SkillFileViewerScreen
import com.anharness.app.ui.settings.UsageStatsScreen
import com.anharness.app.ui.settings.MinisSkillsBrowserScreen
import com.anharness.app.ui.settings.MountDetailScreen
import com.anharness.app.ui.settings.MountedFoldersScreen
import com.anharness.app.ui.settings.SharedFolderDetailScreen
import com.anharness.app.ui.settings.SharedFoldersScreen
import com.anharness.app.ui.settings.SkillsManagementScreen
...
import com.anharness.app.ui.settings.LogDetailScreen
import com.anharness.app.ui.settings.LogManagementScreen
import com.anharness.app.ui.settings.MemoryFileEditScreen
import com.anharness.app.ui.settings.MemoryManagementScreen
import com.anharness.app.ui.settings.OffloadPermissionScreen
import com.anharness.app.ui.settings.ShizukuPermissionScreen
import com.anharness.app.sandbox.RootfsManager
import com.anharness.app.sandbox.TerminalSession
import com.anharness.app.ui.terminal.TerminalScreen
import com.anharness.app.ui.onboarding.OnboardingModelSelectionScreen
...
fun AppNavigation(
    ...
    val mountedFoldersStore = remember {
        (context.applicationContext as com.anharness.app.MinisApp).mountedFoldersStore
    }
    ...
    LaunchedEffect(Unit) {
        ...
        val hasPendingShare =
            com.anharness.app.share.ShareCoordinator.bufferVersion.value > 0
        ...
        val mode = if (
            com.anharness.app.diagnostics.HangDetector.shouldForceHomeOnLaunch(context) ||
            com.anharness.app.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(context) ||
            com.anharness.app.diagnostics.LaunchCycleBeacon.shouldForceHomeOnLaunch()
        ) 3 else rawMode
    ...
    NavHost(
        ...
        composable(Routes.BACKUP) {
            com.anharness.app.ui.settings.backup.BackupAndRestoreScreen(
                onBack = { navController.safePopBackStack() },
        ...
        composable(
            ...
            val history = remember { com.anharness.app.backup.BackupHistory.get(ctx) }
            ...
            if (record == null) {
                ...
                // the screen.
                val vm: com.anharness.app.ui.settings.backup.BackupViewModel =
                    androidx.lifecycle.viewmodel.compose.viewModel()
                com.anharness.app.ui.settings.backup.BackupHistoryDetailScreen(
                    record = record,
                    onBack = { navController.safePopBackStack() },
                    onRemove = {
                        history.remove(id)
        ...
        composable(
            ...
            val remote = remember(name) {
                com.anharness.app.backup.remote.RcloneRemoteStore(ctx).remote(name)
            }
            if (remote == null) {
                ...
                val vm: com.anharness.app.ui.settings.backup.BackupViewModel =
                    androidx.lifecycle.viewmodel.compose.viewModel()
                com.anharness.app.ui.settings.backup.BackupDestinationBrowseScreen(
                    remote = remote,
                    vm = vm,
                    onBack = { navController.safePopBackStack() },
                )
        ...
        composable(Routes.RESTORE_SERVERS) {
            com.anharness.app.ui.settings.backup.RestoreServersScreen(
                onBack = { navController.safePopBackStack() },
                onPickServer = { name ->
                    navController.safeNavigate(
                        "${Routes.RESTORE_BROWSE}/" + android.net.Uri.encode(name),
        ...
        composable(
            ...
            if (remote == null) {
                ...
                com.anharness.app.ui.settings.backup.RestoreBrowseScreen(
                    remote = remote,
                    vm = vm,
                    onBack = { navController.safePopBackStack() },
        ...
        composable(Routes.BACKUP_DESTINATIONS) {
            com.anharness.app.ui.settings.backup.RcloneDestinationsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
            ...
            SharedFolderDetailScreen(
                ...
                onBrowseFiles = {
                    ...
                    val label = when (folderId) {
                        "shared" -> ctx.getString(com.anharness.app.R.string.shared_folder_name_shared)
                        "skills" -> ctx.getString(com.anharness.app.R.string.shared_folder_name_skills)
                        "memory" -> ctx.getString(com.anharness.app.R.string.shared_folder_name_memory)
                        else -> folderId
                    }
        ...
        composable(
            ...
            val category = com.anharness.app.ui.sandbox.MirrorCatalog.categoryFromKey(categoryKey)
                ?: return@composable
            com.anharness.app.ui.sandbox.MirrorCategoryDetailScreen(
                category = category,
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.MCP) {
            if (mcpRepository != null) {
                com.anharness.app.ui.settings.MCPIntegrationsScreen(
                    mcpRepository = mcpRepository,
                    onBack = { navController.safePopBackStack() },
                    envVarRepository = envVarRepository,
                )
        ...
        composable(Routes.SOUL) {
            com.anharness.app.ui.settings.SoulSettingsScreen(
                onBack = { navController.safePopBackStack() },
            )
        }
        ...
        composable(Routes.SCHEDULED_TASKS) {
            com.anharness.app.ui.scheduled.ScheduledTasksScreen(
                onBack = { navController.safePopBackStack() },
                onEditTask = { taskId ->
        ...
        composable(
            ...
            com.anharness.app.ui.scheduled.ScheduledTaskRunsScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
        ...
        composable(
            ...
            com.anharness.app.ui.scheduled.ScheduledTaskEditScreen(
                taskId = taskId,
                onBack = { navController.safePopBackStack() },
                onOpenSession = { sessionId ->
                    navController.safeNavigate(Routes.chat(sessionId))
