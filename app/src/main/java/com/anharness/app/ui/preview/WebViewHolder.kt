    ...
    val webView: WebView = WebView(appContext).apply {
        ...
        webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(
                ...
                if (com.anharness.app.browser.GoogleAuthRouter.shouldRouteExternally(urlStr)) {
                    if (urlStr != null) {
                        com.anharness.app.browser.GoogleAuthRouter.openInCustomTab(view.context, urlStr)
                    }
                    return true
                }
                ...
                return com.anharness.app.ui.browser
