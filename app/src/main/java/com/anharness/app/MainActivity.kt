...
import com.anharness.app.accessibility.AccessibilityRecoveryManager
...
import com.anharness.app.deeplink.DeepLinkHandler
import com.anharness.app.logging.AppLogger
import com.anharness.app.service.SessionActivityTracker
import com.anharness.app.ui.navigation.AppNavigation
import com.anharness.app.ui.navigation.Routes
import com.anharness.app.ui.navigation.safeNavigate
import com.anharness.app.ui.NewerDatabaseGuidanceScreen
import com.anharness.app.ui.settings.KEY_FONT_APP_BASE
import com.anharness.app.ui.settings.KEY_KEEP_SCREEN_AWAKE
import com.anharness.app.ui.settings.KEY_LANGUAGE
import com.anharness.app.ui.settings.KEY_LAUNCH_SESSION
import com.anharness.app.ui.settings.KEY_THEME_MODE
import com.anharness.app.ui.settings.PREF_APPEARANCE
import com.anharness.app.ui.settings.getAppearancePrefs
import com.anharness.app.ui.settings.fontScaleForLevel
import com.anharness.app.ui.settings.keepScreenAwakeEnabled
import com.anharness.app.ui.theme.MinisTheme
...
class MainActivity : ComponentActivity() {
     ...
     * [com.anharness.app.ui.navigation.AppNavigation]'s LaunchedEffect that
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.anharness.app.i18n.LocaleWrap.wrap(newBase))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (minisApp != null &&
            ...
            com.anharness.app.data.db.DatabaseVersionGuard.Decision.SHOW_NEWER_DB_GUIDANCE
        ) {
        ...
        if (minisApp == null || !minisApp.subsystemsInitialized) {
            android.util.Log.w(
                ...
                "app subsystems not initialized (safeMode=" +
                    "${com.anharness.app.crash.CrashFrequencyDetector.isSafeMode()}) — " +
                    "showing crash share dialog and finishing",
            )
            com.anharness.app.crash.CrashFrequencyDetector.maybeShowOnActivity(
                activity = this,
        ...
        restoredChatSessionId = savedInstanceState?.getString(KEY_CURRENT_CHAT_SESSION_ID)
            ?.takeUnless {
                com.anharness.app.crash.CrashFrequencyDetector.shouldForceHomeOnLaunch(this)
            }
        ...
        com.anharness.app.share.ShareCoordinator.processPendingShare(this)
        ...
        if (BuildConfig.DEBUG) {
            com.anharness.app.debug.DebugRPCHandler.currentActivity = java.lang.ref.WeakReference(this)
        }
        ...
        setContent {
            ...
            MinisTheme(darkTheme = darkTheme, fontScale = fontScale) {
                ...
                com.anharness.app.ui.settings.ConfigConfirmDialogHost()
            }
        }
    }
     ...
     * is already covered by [com.anharness.app.ui.navigation.AppNavigation]
