...
import com.anharness.app.data.db.AppDatabase
import com.anharness.app.data.db.DatabaseVersionGuard
...
import com.anharness.app.data.repository.MCPRepository
import com.anharness.app.data.repository.SkillRepository
import com.anharness.app.notification.BackgroundTaskNotifier
import com.anharness.app.logging.AppLogger
import com.anharness.app.network.NetworkMonitor
...
import com.anharness.app.sandbox.MountedFolderCoordinator
import com.anharness.app.sandbox.NativeOffloadServer
import com.anharness.app.sandbox.PRootKernel
import com.anharness.app.sandbox.RootfsManager
import com.anharness.app.sandbox.offload.AccessibilityOffloadHandler
import com.anharness.app.sandbox.offload.AlarmOffloadHandler
import com.anharness.app.sandbox.offload.BrowserUseOffloadHandler
import com.anharness.app.sandbox.offload.CalendarOffloadHandler
import com.anharness.app.sandbox.offload.ClipboardOffloadHandler
import com.anharness.app.sandbox.offload.ContactsOffloadHandler
import com.anharness.app.sandbox.offload.DeviceOffloadHandler
import com.anharness.app.sandbox.offload.LocationOffloadHandler
import com.anharness.app.sandbox.offload.ModelUseOffloadHandler
import com.anharness.app.sandbox.offload.SessionsOffloadHandler
import com.anharness.app.sandbox.offload.ShizukuOffloadHandler
import com.anharness.app.sandbox.offload.NotificationOffloadHandler
import com.anharness.app.sandbox.offload.OpenOffloadHandler
import com.anharness.app.sandbox.offload.PhotosOffloadHandler
import com.anharness.app.sandbox.offload.PlayerOffloadHandler
import com.anharness.app.sandbox.offload.SpeakOffloadHandler
import com.anharness.app.sandbox.offload.SpeechOffloadHandler
import com.anharness.app.sandbox.offload.WeatherOffloadHandler
import com.anharness.app.service.SessionActivityTracker
import com.anharness.app.ui.MinisImageFetcher
...
class MinisApp : Application(), ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        // Activity context.
        com.anharness.app.data.AutoCompactPrefs.prime(this)
        ...
        // libs first execute.
        try {
            com.anharness.app.crash.NativeCrashHandler.install(
            ...
            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                try {
                    ...
                    if (isFgsTimeout) {
                        ...
                        runCatching {
                            val intent = Intent(this, com.anharness.app.service.AgentForegroundService::class.java)
                            stopService(intent)
                        }
                    }
                } catch (t: Throwable) {
        ...
        com.anharness.app.crash.CrashFrequencyDetector.checkAtLaunch(this)
        ...
        // [com.anharness.app.diagnostics.LaunchCycleBeacon].
        try {
            com.anharness.app.diagnostics.LaunchCycleBeacon.recordLaunch(this)
        } catch (t: Throwable) {
        ...
        com.anharness.app.diagnostics.HangDetector.start(this)
        ...
        com.anharness.app.agent.SoulStore.ensureExists(this)
        com.anharness.app.agent.SoulStore.refreshCache(this)
        ...
        com.anharness.app.config.MinisConfigPermissionStore.init(this)
        com.anharness.app.config.audit.ConfigAuditLog.init(this)
        com.anharness.app.config.ConfigRegistry.init(
        ...
        com.anharness.app.data.EnvVarPrivacyStore.init(this)
        com.anharness.app.data.EnvVarRedactor.envVarRepository = envVarRepository
        ...
        NativeOffloadServer.register(
            "minis-config",
            com.anharness.app.sandbox.offload.ConfigOffloadHandler(),
        )
        ...
        NativeOffloadServer.register(
            "minis-scheduled",
            com.anharness.app.sandbox.offload.ScheduledTaskOffloadHandler(this),
        )
        ...
        com.anharness.app.offload.ShizukuManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            NativeOffloadServer.register(
                "minis-debug",
                com.anharness.app.sandbox.offload.DebugOffloadHandler(this),
            )
        }
        ...
        com.anharness.app.service.SessionBadgeStore.init(this)
        ...
        kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.IO).launch {
            ...
            com.anharness.app.service.SessionBadgeStore.reconcileInterruptedSessions(interrupted - active)
        }
        ...
        val configConfirmNotifier = com.anharness.app.notification.ConfigConfirmNotifier(
            context = this,
            backgroundSettings = backgroundSettingsRepository,
            isAppForeground = ::isAppForeground,
        )
        com.anharness.app.config.confirm.ConfigConfirmationGate.backgroundNotifier = {
            configConfirmNotifier.notifyIfBackgrounded(it)
        }
        com.anharness.app.config.confirm.ConfigConfirmationGate.cancelNotification = {
        ...
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacks {
            ...
            override fun onActivityResumed(activity: Activity) {
                ...
                com.anharness.app.crash.CrashFrequencyDetector.maybeShowOnActivity(activity)
            ...
            override fun onActivityStopped(activity: Activity) {
                ...
                if (foregroundActivityCount == 0) {
                    ...
                    com.anharness.app.config.confirm.ConfigConfirmationGate.notifyPending()
                }
            }
        ...
        com.anharness.app.speech.SpeechRecognitionManager.init(this)
        ...
        if (BuildConfig.DEBUG) {
            try {
                com.anharness.app.debug.DebugServer(this).start()
            } catch (e: Exception) {
    ...
    override fun onTrimMemory(level: Int) {
        ...
        runCatching { com.anharness.app.ui.chat.KatexWebViewPool.evictAll() }
            .onFailure { Log.w("MinisApp", "KatexWebViewPool.evictAll failed: ${it.message}") }
        runCatching { com.anharness.app.ui.markdown.KaTeXRendererCache.evictAll() }
        ...
        if (level >= TRIM_MEMORY_COMPLETE) {
            ...
            runCatching { com.anharness.app.ui.chat.KatexWebViewPool.releaseWebView() }
    ...
    override fun onTerminate() {
        ...
        try {
            com.anharness.app.diagnostics.LaunchCycleBeacon.recordCleanExit(this)
        } catch (t: Throwable) {
