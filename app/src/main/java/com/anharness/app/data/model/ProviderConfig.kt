...
data class ProviderInstance(
     ...
     */
    @Serializable(with = com.anharness.app.backup.Iso8601MillisSerializer::class)
...
data class ModelEntry(
    ...
    @Serializable(with = com.anharness.app.backup.Iso8601MillisNullableSerializer::class)
