...
import com.anharness.app.data.model.ModelAttributionSnapshot
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.anharness.app.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.anharness.app.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.anharness.app.share.ChatExporter]
