...
import com.anharness.app.debug.HeadlessChatRunner
import com.anharness.app.logging.AppLogger
import com.anharness.app.service.AgentForegroundService
    ...
    private suspend fun resolveSessionId(app: MinisApp, task: ScheduledTask): String? {
        return when (val mode = task.targetMode) {
            ...
            ScheduledTargetMode.NewSession -> {
                ...
                val memoryOn = com.anharness.app.data.MemoryGlobalPrefs.isGlobalEnabled(app)
