...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun hasStoredCredential(context: Context, instanceId: String): Boolean {
            val prefs = com.anharness.app.util.EncryptedPrefsFactory
        ...
        fun forInstance(context: Context, instance: com.anharness.app.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.anharness.app.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.anharness.app.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.anharness.app.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.anharness.app.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.anharness.app.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
